...
import {
  ...
  Button, Stack, MenuItem, Select, useTheme, Container
} from '@mui/material';
import {
...
>
  ...
  <Select
    ...
    variant="standard"
    disableUnderline
    // Updated styles to remove gaps and center the arrow
    sx={{
  ...
  >
    Search
          ...
          >
            ...
            <HeaderAction icon={<ShoppingCart />} label="My cart" />
          </Stack>
        </Toolbar>
      </Container>
    </AppBar>
...
const HeaderAction = ({ icon, label }) => (
  ...
  >
    {React.cloneElement(icon, { sx: { fontSize: '22px' } })}
